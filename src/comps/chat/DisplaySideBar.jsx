...
const DisplaySideBar = ({ isOpen, btnHandler, handleKeyDown, searchHandler, inviteArray, openConvoHanlder }) => {
    const { /* user, */ inviteHandler, searchValue, setSearchValue, searchedUsers, /* getOneUser, */ } = useContext(UsersContext)
    const { /* messengerId, */ allConversations, /* getAllConversations, */ } = useContext(ConversationContext)
    return(
        <div className={styles.container}>
            ...
            <div className={isOpen ? `${styles.searchWindow} ${styles.openSearchWindow}` : `${styles.searchWindow} ${styles.closedSearchWindow}`}>
                ...
                {isOpen && <div className={styles.overlay} onClick={btnHandler}></div>}
